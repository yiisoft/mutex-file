...
[![Latest Stable Version](https://poser.pugx.org/yiisoft/mutex-file/v)](https://packagist.org/packages/yiisoft/mutex-file)
[![Total Downloads](https://poser.pugx.org/yiisoft/mutex-file/downloads)](https://packagist.org/packages/yiisoft/mutex-file)
[![Build status](https://github.com/yiisoft/mutex-file/actions/workflows/build.yml/badge.svg)](https://github.com/yiisoft/mutex-file/actions/workflows/build.yml)
[![Code Coverage](https://codecov.io/gh/yiisoft/mutex-file/branch/master/graph/badge.svg)](https://codecov.io/gh/yiisoft/mutex-file)
